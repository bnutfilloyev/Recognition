...
class MTCNN(object):
    ...
    def __init__(self, min_face_size: int = 20, steps_threshold: list = None,
        ...
        pnet_path = os.path.join(os.path.dirname(__file__), "weights/pnet.onnx")
        rnet_path = os.path.join(os.path.dirname(__file__), "weights/rnet.onnx")
        onet_path = os.path.join(os.path.dirname(__file__), "weights/onet.onnx")
        """
